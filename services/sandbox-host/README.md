...
For local R2 mounts, set `R2_ACCESS_KEY_ID`, `R2_SECRET_ACCESS_KEY`, `R2_ACCOUNT_ID`, and `R2_BUCKET_NAME`
in `.dev.vars` or Terraform tfvars. The local loader maps Terraform `r2_*` keys to `R2_*` env vars automatically.
