...
export default function InvitationPage() {
  ...
  const orgId = normalizeParam(params.orgId);
      ...
      <div className="flex w-full max-w-sm flex-col gap-6">
        ...
        <Card className="w-full">
          ...
          {showInviteCard && invitation && (
            <>
              <CardHeader className="text-center">
                <CardTitle className="text-lg">You&apos;re invited to join</CardTitle>
                <CardDescription className="text-base font-semibold text-foreground">
                  {invitation.org.name}
                </CardDescription>
                <div className="text-sm text-muted-foreground">
                  You&apos;ll still have access to any other orgs or workspaces you&apos;re part of.
                  This just adds you to a new one.
                </div>
              </CardHeader>
              <CardContent className="flex flex-col gap-3">
                {authLoading ? (
