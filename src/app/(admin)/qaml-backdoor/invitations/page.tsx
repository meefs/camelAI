...
export default async function AdminInvitationsPage({ searchParams }: Props) {
  ...
  const { items: invitations, total } = await authDO.adminGetInvitationsPaginated({
    offset,
    limit: LIMIT,
                  ...
                  invitations.map((invitation) => {
                    ...
                    return (
                      <TableRow key={`${invitation.org_id}-${invitation.id}`}>
                        ...
                        <TableCell>
                          <Link
                            href={`/qaml-backdoor/orgs/${invitation.org_id}`}
                        ...
                        <TableCell>
                          <Link
                            href={`/qaml-backdoor/users/${invitation.invited_by}`}
                            className="block hover:underline"
                          >
